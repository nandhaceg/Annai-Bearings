...
<body>
    ...
    <div id="mySidenav" class="sidenav">
      <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
       <a href="<?php echo base_url ('Home/Purchase_type'); ?>">Update</a>
      <a class="active" href="<?php echo base_url ('Home/Category'); ?>">Home</a>
      <a href="<?php echo base_url ('Home/Belt'); ?>">Belt</a>
      <a href="<?php echo base_url ('Home/Bearings'); ?>">Baring</a>
      <a href="<?php echo base_url ('Home/Pully'); ?>">Pully</a>
      <a href="<?php echo base_url ('Home/index'); ?>">Logout</a>
    </div>
    <div id="main">
        <span style="font-size:30px;cursor:pointer;color:white;" onclick="openNav()">&#9776; Add</span>
        <div class="row">
