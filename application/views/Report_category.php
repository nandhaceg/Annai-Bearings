...
<body>
    ...
    <div id="mySidenav" class="sidenav">
      ...
      <a href="<?php echo base_url ('Home/Belt_purchase_report'); ?>">Belt</a>
      <a href="<?php echo base_url ('Home/Bearings_purchase_report'); ?>">Barings</a>
      <a href="<?php echo base_url ('Home/Pully_purchase_report'); ?>">Pully</a>
      <a href="<?php echo base_url ('Home/index'); ?>">Logout</a>
    </div>
    <div id="main">
        <span style="font-size:30px;cursor:pointer;color:white;" onclick="openNav()">&#9776; Purchase Report</span>
        <div class="row">
